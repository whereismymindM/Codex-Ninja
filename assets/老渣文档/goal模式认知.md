...
> 来源：2026-08-08 一号舱室 001-008 轮实测 + 007 轮老渣×林纳斯对话定稿。
...
- **objective_evidence**：kind=file，paths 用**相对路径**（`我的世界/产出/任务NNN/文件名.md`），summary 写**文件系统事实**（产出+.ready 在位/签字在位/退场文件在位），accepted=true
...
- 改造说明（方案/工具/维护）：`工具舱/reasonix-改造/改造说明.md`
- 实测归档：`档案馆/14_reasonix文件判据改造/`（设计文档/组团评审/实测结论/双轨模型）
