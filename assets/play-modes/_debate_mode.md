...
- **本轮后：休眠** → 写流水账 → 创建休眠文件 → bash while + _reasonix_poll.js 轮询（每3s）——循环骨架见 `_workflow.md`「休眠」节

- **本轮后：待命** → bash while + _reasonix_poll.js --standby 轮询（每15s）——循环骨架见 `_startup_steps.md`
