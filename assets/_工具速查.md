...
- **改模板/文档后、提交前跑一次**——从代码枚举事实（模式枚举/模板数/调查轮/输出/退出码/铁律编号/引用存在/轨迹残留）断言文档一致，数字/引用/路径漂移自动报警（**完整使用说明见同目录 `scripts/doc-consistency-使用说明.md`**；计划书：阅览室/doc-consistency校验脚本-计划书.md）
