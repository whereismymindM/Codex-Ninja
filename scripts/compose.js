...
// {
//   "项目": "项目名",
//   "角色": ["架构师-林纳斯", "技术VP-马斯克", "AI研究员-辛顿"],
//   "轮次": [
//     { "模式": "单人输出|辩论|主笔审核|双人对话|待命|收工",
//       "角色": { "架构师-林纳斯": "正方", "技术VP-马斯克": "反方", "AI研究员-辛顿": "裁判" },  // 模式角色字段（辩论等）
//       "任务": "任务描述",
//       "产出负责人": "AI研究员-辛顿",   // 单人/主笔/辩论/双人必填；待命/收工不填
//       "产出": "我的世界/产出/任务001_XX/文件名.md",
//       "任务目录": "我的世界/任务001_XX/",
//       "警告": "可选，本轮临时约束",
//       "本轮后": { "架构师-林纳斯": "休眠" }   // 可选，默认活跃→待命
//     }
//   ]
// }
//
...
var MODES = ["单人输出", "辩论", "主笔审核", "双人对话", "待命", "收工"];
...
cfg.轮次 && cfg.轮次.forEach(function(r, ri) {
  ...
  // 产出字段：任务轮必填，收工/待命不填
  var needOutput = r.模式 === "单人输出" || r.模式 === "辩论" || r.模式 === "主笔审核" || r.模式 === "双人对话";
  if (needOutput) {
...
var RETIRE_TASK = "全员退场。①收工前确认你的职责已尽：盘点本项目/前几轮公告牌分配给你的任务是否已交付——未尽则先补交/求助/说明，不得直接退场 ②写流水账（独立文件 {角色名}_流水账.md，回顾全程每轮一行）③【终局轮】写 {角色名}_角色记忆.md 到对讲目录（传承给下一任的自己）④创建退场文件 ⑤输出「项目完成」结束回合。";
